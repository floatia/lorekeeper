...
@if($submission->status == 'Pending')
    ...
    {!! Form::open(['url' => url()->current(), 'id' => 'submissionForm']) !!}
        ...
        <h2>Rewards</h2>
        @include('widgets._loot_select', ['loots' => $submission->rewards, 'showLootTables' => true, 'showRaffles' => true, 'showStatuses' => false])
        @if($submission->prompt_id)
            <div class="mb-3">
    ...
    @include('widgets._loot_select_row', ['items' => $items, 'currencies' => $currencies, 'showLootTables' => true, 'showRaffles' => true, 'showStatuses' => false])
